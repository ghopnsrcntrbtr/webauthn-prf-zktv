...
## Corpus Check
- Corpus is ~7,551 words - fits in a single context window. You may not need a graph.

## Summary
- 153 nodes · 424 edges · 6 communities (5 shown, 1 thin omitted)
...
## Knowledge Gaps
- **27 isolated node(s):** `prfOutput`, `fastParams`, `salt`, `prfRecord`, `pwRecord` (+22 more)
