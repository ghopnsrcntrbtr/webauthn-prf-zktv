...
\begin{itemize}
  ...
  \item \textbf{Keep telemetry and analytics out of the unlock/wrap path.} No metrics, crash reports, or usage analytics should be scoped to \texttt{enrollVault}\slash\texttt{unlockVault} calls or fire conditionally on their success/failure in a way that leaks timing or outcome to a third party.
